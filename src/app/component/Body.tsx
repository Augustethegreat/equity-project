...
function TheBody() {
  ...
  Stay up to date with the latest Equity BCDC news and products.
            </p>
          ...
          <div className='block md:block md:px-8  lg:flex px-4 md:w-full lg:px-0 md:gap-x-2 items-center mx-auto  mt-10 pb-3 ' >
              ...
              <div className=' text-[#272828] '>
                ...
                <p className=' w-full  font-normal md:px-0 lg:px-0    lg:w-[100%]   text-[11px] md:text-[15px] lg:text-[13px]'>Create an account to open and manage your account
                    banking, easily and securely. Order
                    your card, submit a loan application and
                    order our digital products available on
                    our portal. </p>
             ...
             <button className='bg-[#a22a2b] hover:bg-[#d73611] w-full rounded-[5px] lg:w-[190px] h-[40px] text-[11px] font-bold text-white '>
             CREATE YOUR ACCOUNT</button>
              ...
              <div className=' text-[#272828] '>
                ...
                <p className=' w-full md:px-0 lg:px-0  font-normal px-1   lg:w-[100%]   text-[11px] md:text-[15px] lg:text-[13px]'>Receive exclusive offers and updates on
                  our DIASPORA products. Be the first to know about
                  our special offers of banking products and our
                  competition.</p>
              ...
              <div className=' md:flex lg:flex  justify-center mt-2 mt:mt-0 lg:mt-0 pd-3 gap-x-1 md:gap-x-1 lg:gap-x-3'>         
                  ...
                  <input type="text" name="" id="" placeholder='  Your name ' className='border-[1px] w-full px-2 md:w-[300px] lg:w-[155px] rounded-[4px] border-[#a22a2b] text-[#272828] h-[40px] text-[11px]'/>
                  </div>
                  <div className='py-2 px-10 md:px-0 lg:px-0 md:py-0 lg:py-0'>
                  <input type="text" name="" id="" placeholder='  Your email' className='border-[1px] w-full px-2  md:w-[300px] lg:w-[155px] rounded-[4px] border-[#a22a2b] text-[#272828] h-[40px] text-[11px]'/>
                    </div>                
                  <div className='py-2 px-10 md:px-0 lg:px-0 md:py-0 lg:py-0'>
        ...
        <p className='text-[#272828] mt-2 px-4 text-[11px] md:text-[12px] lg:text-[14px]  '>Designed to provide you with daily services as if you were at home. Open your account and stay in control
          from anywhere in the world through online banking while earning interest and bonuses on your
          money.</p>

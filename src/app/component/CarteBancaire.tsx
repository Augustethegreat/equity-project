...
export default function CarteBancaire() {
  return (
    <div className='space-y-5'>
        <div className='block lg:flex space-y-5 lg:space-y-0 justify-center items-center mx-auto gap-x-10'>
            <div className='shadow-xl rounded-[10px]'>
            <Image src={carteRed} className='w-full h-auto rounded-t-[10px]' alt=''/>
            <div className='text-[#000]'>
                
                <p className='text-[25px] font-semibold w-full py-3 text-white bg-[#a22a2b]'>Mastercard prépayée</p>
        ...
        <div className='shadow-xl rounded-[10px]'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[25px] font-semibold w-full py-3 text-white bg-[#a22a2b]'>Mastercard Crédit </p>
        ...
        <div className='shadow-xl rounded-[10px]'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[25px] font-semibold w-full py-3 text-white bg-[#a22a2b]'>Mastercard Débit Standard </p>
        ...
        <div className='block lg:flex space-y-5 lg:space-y-0 justify-center items-center mx-auto gap-x-10'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[25px] font-semibold w-full py-3 text-white bg-[#a22a2b]'>Visa Classique </p>
                <p className='text-[20px] font-semibold'>Cartes internationales</p> 
                <div className='text-start font-light px-2 w-full lg:w-[350px] h-[180px]'>
                    <p>- Prix de la carte : 30 USD + TVA</p>
                    <p>- Limite journalière : retrait 2500 USD et Paiement/Achat en ligne : 3500 USD</p>
        ...
        <div className='shadow-xl rounded-[10px]'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[25px] font-semibold w-full py-3 text-white bg-[#a22a2b]'>Visa Gold</p>
        ...
        <div className='shadow-xl rounded-[10px]'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[25px] font-semibold w-full py-3 text-white bg-[#a22a2b]'>Visa Platinum</p>
                <p className='text-[20px] font-semibold'>Cartes Prestiges</p> 
                <div className='text-start font-light px-2 w-full lg:w-[350px] h-[180px]'>
        ...
        <div className='block lg:flex space-y-5 lg:space-y-0 justify-center items-center mx-auto gap-x-10'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[25px] font-semibold w-full py-3 text-white bg-[#a22a2b]'>Visa Infinite </p>
                <p className='text-[20px] font-semibold'>Cartes Prestiges</p> 
                <div className='text-start font-light px-2 w-full lg:w-[350px] h-[180px]'>
        ...
        <div className='shadow-xl rounded-[10px]'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[25px] font-semibold w-full py-3 text-white bg-[#a22a2b]'>Mastercard World Elite</p>
                <p className='text-[20px] font-semibold'>Cartes Prestiges  </p> 
                <div className='text-start font-light px-2 w-full lg:w-[350px] h-[180px]'>

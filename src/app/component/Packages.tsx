       ...
       <div className='mx-auto  items-center justify-center pt-[70px] md:px-6 mt-10 lg:max-w-screen-xl pb-[150px]'>
         ...
         <div className='border-[#ebebeb] border-[1px] w-full md:w-[400px] rounded-[20px] shadow-xl shadow-[#bcbcbc] '>
           <div className='text-black p-7'>
                ...
                <p className='lg:w-[325px] h-[120px] text-[16px] pt-2'>The Equity current account allows you to have your money when and how you want, 24/7.</p>
            ...
            style={{borderBottomRightRadius:'20px', borderBottomLeftRadius:'20px'}}>
                <div className='flex px-7 py-5 text-[19px] gap-x-[45%] lg:gap-x-[35%]'>
                <a href='https://www.equitybcdc-diasporabanking.com/equity-bank-ui/auth/login?returnUrl=%2Fhome'>
                  <p>Subscribe</p>
                </a>
                <a >
                <p className='hover:cursor-pointer'   onClick={() => setLoginOpen2(true)}>Learn more +</p>
                </a>
                </div>
            </div>
           </div>
           <div className='border-[#ebebeb] border-[1px] w-full md:w-[400px] rounded-[20px] shadow-xl shadow-[#bcbcbc] '>
           <div className='text-black p-7'>
                <p className='font-semibold text-[22px] text-[#636569]'>Saving</p>
                <p className='lg:w-[325px] h-[120px] text-[16px] pt-2'>We offer our adult clientele two types of savings account to help them carry out their projects.</p>
            ...
            style={{borderBottomRightRadius:'20px', borderBottomLeftRadius:'20px'}}>
                ...
                <a >
                <p className='hover:cursor-pointer' onClick={() => setLoginOpen(true)}>Learn more +</p>
                </a>
                </div>
            </div>
           </div>
           ...
           <div className='text-black p-7'>
                ...
                <p className='lg:w-[325px] h-[120px] text-[16px] pt-2'>Through the Equity DAT account, we offer holders of a current or savings account the possibility of making profitable investments in the form of a blocked account for maturities defined on the list of bank rates</p>
            ...
            style={{borderBottomRightRadius:'20px', borderBottomLeftRadius:'20px'}}>
                ...
                <a >
                <p className='hover:cursor-pointer' onClick={() => setLoginOpen1(true)}>Learn more +</p>
                </a>
                </div>
            </div>
           </div>
           ...
           <div className='text-black p-7'>
                ...
                <p className='lg:w-[325px] h-[120px] text-[16px] pt-2'>Compte permettant la constitution d'une épargne rémunérée sans obligation de durée...</p>
      ...
      >
        ...
        <Dialog.Panel className="relative max-w-4xl lg:w-full mt-7 shadow-xl rounded-[15px] lg:px-0 bg-[#fcfcfc]">
          ...
          <div className='border-t-[1px] border-b-[1px] border-[#575656] py-2'>
            <p className='text-[20px] font-medium  '>LIST OF BENEFITS</p>         

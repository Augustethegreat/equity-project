        ...
        >
          <Popover.Panel className="absolute bg-white  top-full z-10 mt-3 w-[160px]  overflow-hidden hover:cursor-pointer  shadow-lg text-[#646464] ">
            <div className=" gap-y-3">
                  ...
                  <a href="#diaspora"  className={`font-medium text-[15px] leading-6   hover:text-[#ffffff] hover:border-b-[#a22a2b] ${loginOpen ? ' border-b-[#eaeaea] ' : ''}`} >
                  La Diaspora Banking
                  </a>
                  </div>
              <div onClick={aboutroute2} className="w-full pl-2 py-3 mt-1 text-black hover:text-white hover:bg-[#a22a2b] bg-white">
              <a href="#portail" className={`font-medium text-[15px] leading-6   hover:text-[#ffffff] hover:border-b-[#a22a2b] ${loginOpen ? ' border-b-[#eaeaea] ' : ''}`} >

...
function product3() {
  ...
  return (
    <div className='block lg:flex text-[#323232] md:h-auto lg:h-[700px] gap-x-3 mx-auto items-center justify-center space-y-10 lg:space-y-0 px-4 lg:px-[50px]'>
        <div className='shadow-xl  rounded-[15px] w-full lg:w-[500px]'>
            <div className=''>
            <p className='text-center  border-[#a22a2b] rounded-t-[15px] bg-[#a22a2b] py-3 font-medium text-white text-[30px]'>PACK EPARGNE DIASPORA</p>
            <p className='text-center text-[23px] py-2 border-b-[2px]'>Contient Un Compte Epargne Diaspora</p>
            ...
            <div className='border-t-[2px] text-[18px] text-start space-y-3 px-2 h-auto lg:h-[240px]' style={{display:show1}}>
            ...
            <div className='border-t-[2px] flex items-center justify-evenly rounded-b-[15px] text-[20px] font-semibold '>
                 <p className='py-3 hover:bg-[#a22a2b] hover:text-white hover:cursor-pointer w-full rounded-l-[10px]' onClick={product1}>{butt1}</p>
                <p className='py-3 hover:bg-[#a22a2b] hover:text-white hover:cursor-pointer w-full rounded-r-[10px]'>Souscrire</p>
            </div>
            </div>
        </div>
        ...
        <div className='shadow-xl rounded-[15px] w-full lg:w-[500px]'>
            ...
            <p className='text-center text-[23px] py-2 border-b-[2px]'>Contient Un Compte Courant Diaspora</p>
            <div className='text-[18px] font-normal text-start px-2 space-y-4 py-2 h-auto lg:h-[200px]'>
                <p>•	Dépôt initial minimum : 100 USD ou équivalent </p>
            ...
            <div className='border-t-[2px] text-[18px] text-start space-y-3 px-2 h-auto lg:h-[240px]' style={{display:show2}}>
            ...
            <div className='border-t-[2px] flex items-center justify-evenly rounded-b-[15px] text-[20px] font-semibold '>
                 <p className='py-3 hover:bg-[#a22a2b] hover:text-white hover:cursor-pointer w-full rounded-l-[10px]' onClick={product2}>{butt2}</p>
                <p className='py-3 hover:bg-[#a22a2b] hover:text-white hover:cursor-pointer w-full rounded-r-[10px]'>Souscrire</p>
            </div>
            </div>
        </div>
        ...
        <div className='shadow-xl rounded-[15px] w-full lg:w-[500px]'>
            ...
            <div className='border-t-[2px] text-[18px] text-start space-y-3 px-2 h-auto lg:h-[240px]' style={{display:show3}}>
            ...
            <div className='border-t-[2px] flex items-center justify-evenly rounded-b-[15px] text-[20px] font-semibold '>
                 <p className='py-3 hover:bg-[#a22a2b] hover:text-white hover:cursor-pointer w-full rounded-l-[10px]' onClick={product3}>{butt3}</p>
                <p className='py-3 hover:bg-[#a22a2b] hover:text-white hover:cursor-pointer w-full rounded-r-[10px]'>Souscrire</p>
            </div>
            </div>
        </div>
